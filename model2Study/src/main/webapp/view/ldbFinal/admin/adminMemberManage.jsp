...
<head>
  ...
  <script>
    function openEmployeeDetail(empNo) {
      const url = "employeeDetail.jsp?empNo=" + empNo;
  ...
  <table class="table table-bordered">
    ...
    <tbody id="memberTableBody">
      <tr data-dept="개발팀" data-rank="대리">
        ...
        <td>대리</td>
        <td>1</td>
        <td><a href="memberLevelEdit.jsp?empNo=20250001" class="btn btn-sm btn-outline-primary">설정</a></td>
      </tr>
      <tr data-dept="영업팀" data-rank="과장">
        ...
        <td>과장</td>
        <td>2</td>
        <td><a href="memberLevelEdit.jsp?empNo=20250002" class="btn btn-sm btn-outline-primary">설정</a></td>
      </tr>
      <tr data-dept="총무팀" data-rank="사원">
        ...
        <td>사원</td>
        <td>1</td>
        <td><a href="memberLevelEdit.jsp?empNo=20250003" class="btn btn-sm btn-outline-primary">설정</a></td>
      </tr>
      <tr data-dept="디자인팀" data-rank="주임">
        ...
        <td>주임</td>
        <td>1</td>
        <td><a href="memberLevelEdit.jsp?empNo=20250004" class="btn btn-sm btn-outline-primary">설정</a></td>
      </tr>
      <tr data-dept="개발팀" data-rank="팀장">
        ...
        <td>팀장</td>
        <td>3</td>
        <td><a href="memberLevelEdit.jsp?empNo=20250005" class="btn btn-sm btn-outline-primary">설정</a></td>
      </tr>
    </tbody>
  </table>
</div>
