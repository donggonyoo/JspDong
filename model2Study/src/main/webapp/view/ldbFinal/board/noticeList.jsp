...
<div class="container mt-5">
    ...
    <!-- 검색 폼 -->
    <form action="noticeList.jsp" method="get" class="row g-2 mb-4">
        <div class="col-md-3">
            ...
            <tbody>
                ...
                <tr class="fixed-row">
                    ...
                    <td class="notice-title">
                        <a href="noticeDetail.jsp?id=101" class="text-decoration-none text-dark">
                            [중요] 서버 점검 안내 (7/15)
                        </a>
                    </td>
                    <td>관리자</td>
                ...
                <tr class="fixed-row">
                    ...
                    <td class="notice-title">
                        <a href="noticeDetail.jsp?id=100" class="text-decoration-none text-dark">
                            [공지] 그룹웨어 기능 개선 안내
                        </a>
                    </td>
                    <td>관리자</td>
